...
| [workflow-plugin-acpx](./plugins/workflow-plugin-acpx/manifest.json) | ACPX durable bundle validation and summaries | community |
...
| [workflow-plugin-compute](./plugins/workflow-plugin-compute/manifest.json) | Workflow adapter for workflow-compute dispatch, wait, map, chain, provider, pool, catalog, and product-capture workloads | community |
...
| [workflow-plugin-encrypted-spaces](./plugins/workflow-plugin-encrypted-spaces/manifest.json) | Encrypted Spaces collaboration primitives for Workflow | community |
...
| [workflow-plugin-signal](./plugins/workflow-plugin-signal/manifest.json) | Signal protocol primitives for Workflow with durable trust stores and redacted trust history | community |
