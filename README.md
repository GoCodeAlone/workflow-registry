...
| [workflow-plugin-infra](./plugins/workflow-plugin-infra/manifest.json) | Abstract infra.* module types with IaCProvider delegation + the infra.admin React SPA (admin interface for IaC, plugs into workflow-plugin-admin) | community |
